                ...
                <?php else: ?>
                    ...
                    <form method="post" action="?action=recuperar-password">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="respuesta_seguridad" name="respuesta_seguridad" class="form-input" placeholder="Ingresa tu respuesta de seguridad" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="nueva_contraseña" name="nueva_contraseña" class="form-input" placeholder="Ingresa tu nueva contraseña" required>
